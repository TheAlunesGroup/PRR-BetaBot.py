...
st.set_page_config(page_title = "PowerHouse River Resort", page_icon = "PowerHouse_River_Resort-removebg-preview.png", layout="wide")

image = Image.open("PowerHouse_River_Resort-removebg-preview.png")
                           ...
                           if Starting_Date > Ending_Date:
                               ...
                               if BN == "Normal":
                                   if Number_of_Adults_1 == 2 and Number_of_Children_0_5_1 == 1 and Number_of_Children_6_11_1 == 1:
                                       ...
                                       Number_of_Adults_1_Price = 20000
                                       Number_of_Children_6_11_1_Price = Number_of_Children_6_11_1 * 4000
                                       Summary_T = f"Booking Summary \n Name:{Name_Entry} \n Check-in Date:{Starting_Date} \n Check-Out Date:{Ending_Date} \n Meal Plan:{Board_Select_Box} \n Amount of Room: 1 \n Type of Room: Deluxe \n Amount of people:4 \n Total Price:{Number_of_Adults_1_Price + Number_of_Children_6_11_1_Price + (Number_of_Adults_1 * 2000) + (Number_of_Children_6_11_1 * 1000)}"
                                       Summary = st.markdown(
                                       ...
                                       count = 1
                                       Number_of_Adults_1_Price = 20000
                                       Summary_T = f"Booking Summary \n Name:{Name_Entry} \n Check-in Date:{Starting_Date} \n Check-Out Date:{Ending_Date} \n Meal Plan:{Board_Select_Box} \n Amount of Room: 1 \n Type of Room: Deluxe \n Amount of people:3 \n Total Price:{Number_of_Adults_1_Price + (Number_of_Adults_1 * 2000)}"
                                       Summary = st.markdown(
