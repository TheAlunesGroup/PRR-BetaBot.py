def booking():
    ...
    if rooms == 1:
        ...
        print(
            "Delux rooms have connected toliets and one queen sized bed and a small bed. One person is 20000 and two people is 24000. aditonal is 2000. The limit for Delux is three people")
        print(
            "Standard rooms have two queen sized beds but dosent have connected bathrooms. One person is 17000, two people is 20000. aditional people is 8000. limit for stadered is 4 people")
    ...
    if rooms == 2:
        ...
        if response == "DS" or response == "ds" or "SD" or response == "sd" or response == "3" or response == "D" or response == "d" or response == "1" or response == "S" or response == "s" or response == "2":
            ...
            while check1 == 0:
                ...
                print("Note that we do not have single(1 person) rates")
                print(
                    "What do you choses. Two delux rooms(D), Two Standard rooms(S) or One standard and delux rooms(SD/DS)")
                response = input(":")
                if response == "DS" or response == "ds" or "SD" or response == "sd" or response == "3" or response == "D" or response == "d" or response == "1" or response == "S" or response == "s" or response == "2":
                    check1 = check1 + 1
                else:
        ...
        if response == "D" or response == "d" or response == "1" or response == "Delux" or response == "delux":
            ...
            if add_P > 6 and add_P < 2:
                while check < 1:
                    print(
                        "The total amount of people has passed or the there is less than two people, please try again")
                    check = 0
                    print("Enter the following for the first delux room")
                    NoA = int(input("How many adults aged 13 and above:"))
                    NoC5 = int(input("How many children aged 0 - 5:"))
        ...
        if response == "Standard" or response == "standard" or response == "S" or response == "s" or response == "2":
            ...
            if NoA == 0 or NoA < 2:
                while check1 < 1:
                    print(
                        "You got an error. You need to have at least two adults or it may have passed the limit(4). Try again")
                    NoA = int(input("How many adults aged 13 and above:"))
                    if NoA > 1:
                        check1 = check1 + 1
                    else:
            ...
            if NoA1 == 0 or NoA1 < 2:
                while check2 < 1:
                    print(
                        "You got an error. You need to have at least two adults or it may have passed the limit. Try again")
                    NoA1 = int(input("How many adults aged 13 and above:"))
                    if NoA1 > 1:
                        check2 = check2 + 1
                    else:
            ...
            if add_P > 8 or add_P < 2:
                while check < 1:
                    ...
                    if NoA1 == 0 or NoA1 < 2:
                        while check2 < 1:
                            print(
                                "You got an error. You need to have at least two adults or has passed the limit(3), try again")
                            NoA1 = int(input("How many adults aged 13 and above:"))
                            if NoA1 > 1:
                                check2 = check2 + 1
                            else:
                    ...
                    if add_P <= 8 and add_P > 1:
                        while check < 1:
                            ...
                            if NoA == 0 or NoA < 2:
                                while check1 < 1:
                                    print(
                                        "You got an error. You need to have at least two adults or it has passed the limit(4)")
                                    NoA = int(input("How many adults aged 13 and above:"))
                                    if NoA > 1:
                                        check1 = check1 + 1
                                    else:
                            ...
                            if NoA1 == 0 or NoA1 < 2:
                                while check1 < 1:
                                    print(
                                        "Error. There should be at least two adults or it may have passed the limit. Try again")
                                    NoA1 = int(input("How many adults aged 13 and above:"))
                                    if NoA1 > 1:
                                        check1 = check1 + 1
                                    else:
    ...
    if rooms == 3:
        ...
        print("Note that we do not have single(1 person) rates")
        print(
            "What do you choses. Two delux rooms and one standard room(DDS) or two standard rooms and one delux room(SSD)")
        response = input("")
            ...
            if add_P > 11:
                while check0 < 1:
                    ...
                    if NoA1 < 2 or NoA1 > 3:
                        while check1 < 1:
                            print(
                                "Error. The limit has passed the room limit(3) or the adults is less than 2. Try again")
                            NoA1 = int(input("How may adults aged 13 and above:"))
                            if NoA1 < 5 and NoA1 > 1:
                                check1 = check1 + 1
                            else:
